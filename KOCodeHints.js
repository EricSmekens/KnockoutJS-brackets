/*
 * Original file by: 2014 C Oliff
 * 
 * Some changes were made for the Knockout plugin for brackets. 
 * My thanks to C Oliff.
 */
...
define(function (require, exports, module) {
    ...
    var CodeHintManager     = brackets.getModule("editor/CodeHintManager"),
        ...
        HTMLTags            = require("text!KOHtmlTags.json"),
        HTMLAttributes      = require("text!KOHtmlAttributes.json"),
        tags,
        attributes;
    ...
    AttrHints.prototype.insertHint = function (completion) {
        ...
        if (insertedName) {
            ...
            return true;
        } else if (tokenType === HTMLUtils.ATTR_VALUE && completion.charAt(completion.length - 1) === ":") {
            //We just selected a ko binding inside data-bind attribute.
    ...
    function initKOCodeHinter() {
        ...
        CodeHintManager.registerHintProvider(tagHints, ["html"], 10);
        CodeHintManager.registerHintProvider(attrHints, ["html"], 10);
    }
    
    exports.initKOCodeHinter = initKOCodeHinter;
});