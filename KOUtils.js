...
define(function (require, exports, module) {
     ...
     * @type {RegExp}
     */
    var _functionRegExp = /\.computed\(['"]([a-zA-Z-]+)['"]/g;
     ...
     */
    function findAllMatchingComputedInText(text, searchName) {
    ...
    exports.findAllMatchingComputedInText = findAllMatchingComputedInText;
